...
//   {
//     id: 1,
//     name: 'Gulu Royal Hotel',
//     location: 'Gulu City Center',
//     rating: 4.5,
//     pricePerNight: 120,
//     images: [
//       'https://images.unsplash.com/photo-1582719478250-c0cec7a50cm2',
//       'https://images.unsplash.com/photo-1582719478250-c0cec7a50cm3'
//     ],
//     amenities: ['WiFi', 'Pool', 'Gym', 'Parking', 'Spa'],
//     rooms: [
//       { type: 'Standard', capacity: 2, price: 120 },
//       { type: 'Deluxe', capacity: 3, price: 180 },
//       { type: 'Suite', capacity: 4, price: 250 }
//     ]
//   },
//   {
//     id: 2,
//     name: 'Northern Comfort Inn',
//     location: 'Gulu Suburbs',
//     rating: 4.2,
//     pricePerNight: 95,
//     images: [
//       'https://images.unsplash.com/photo-1582719478250-c0cec7a50cm4',
//       'https://images.unsplash.com/photo-1582719478250-c0cec7a50cm5'
//     ],
//     amenities: ['WiFi', 'Parking', 'Restaurant'],
//     rooms: [
//       { type: 'Standard', capacity: 2, price: 95 },
//       { type: 'Family', capacity: 4, price: 150 }
//     ]
//   }
// ];
...
//       // Price filter
//       const meetsPriceFilter = hotel.pricePerNight >= filters.priceRange[0] && 
//                                 hotel.pricePerNight <= filters.priceRange[1];

//       // Rating filter
//       const meetsRatingFilter = hotel.rating >= filters.rating;

//       // Amenities filter
//       const meetsAmenitiesFilter = filters.amenities.length === 0 || 
//         filters.amenities.every(amenity => hotel.amenities.includes(amenity));

//       // Guest capacity filter
//       const meetsGuestFilter = hotel.rooms.some(room => room.capacity >= filters.guests);

//       return meetsPriceFilter && meetsRatingFilter && meetsAmenitiesFilter && meetsGuestFilter;
//     });
...
//     <div className={`bg-white shadow-lg rounded-lg p-6 ${showFilters ? 'block' : 'hidden'} md:block`}>
...
//       <div className='mb-4'>
//         <label className='block text-sm font-medium text-gray-700 flex items-center'>
//           <CheckCircle className='mr-2 text-gray-500' />
//           Amenities
//         </label>
...
//                 />
//                 <AmenityIcon className='text-gray-500' size={20} />
//                 <span>{amenity}</span>
//               </label>
//             );
//           })}
...
//           <MapPin className='mr-2 text-[#B22222]' size={20} />
//           {hotel.location}
//         </div>
...
//                 title={amenity}
//               >
//                 <AmenityIcon size={20} className='text-gray-600' />
//               </div>
//             );
//           })}
//         </div>
...
//               <p className='text-xs text-gray-500'>{room.capacity} guests</p>
//             </div>
//           ))}
//         </div>
...
//           <Hotel className='mr-4 text-[#B22222]' /> 
//           Hotels in Gulu
//         </h1>
//         <button 
...
//               <p className='text-xl text-gray-600'>No hotels match your filters.</p>
//             </div>
//           ) : (
